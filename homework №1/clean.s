...
input:
	...
	mov	QWORD PTR -28[rbp], rsi					# [-28] = size
	mov	QWORD PTR -32[rbp], rdx					# [-32] = x

	mov	QWORD PTR -4[rbp], 0					# valid_size = 0
	mov	r12, 0					# i = 0	
	jmp	.L2							# goto .L2
...
.L4:
	...
	add	QWORD PTR -4[rbp], 1					# ++valid_size
...
.L2:
	mov	rax, r12					# eax = i
	cmp	rax, QWORD PTR -28[rbp]					# compare (eax, size)
	jl	.L4							# if (i < 4) goto .L4
	mov	rax, QWORD PTR -4[rbp]					# eax = valid_size			
	leave								# return eax
	ret
	.size	input, .-input
...
make_new_array:
	...
	mov	QWORD PTR -36[rbp], rdx					# [-36] = size
	mov	QWORD PTR -40[rbp], rcx					# [-40] = x
	mov	QWORD PTR -4[rbp], -1					# index = -1
	mov	r12, 0					# i = 0
	jmp	.L7							# goto .L7
...
.L9:
	...
	cmp	QWORD PTR -40[rbp], rax					# compare(old_array[rax], x)
	...
	mov	rax, QWORD PTR -24[rbp]					# rax = old_array
	add	rax, rdx						# rax += rdx
	add	QWORD PTR -4[rbp], 1					# ++index
	mov	rdx, QWORD PTR -4[rbp]					# edx = index
...
.L7:
	mov	rax, r12					# eax = i
	cmp	rax, QWORD PTR -36[rbp]					# compare(i, size)
...
output:
	...
	mov	QWORD PTR -28[rbp], rsi					# [-28] = valid_size
	mov	r12, 0					# i = 0
	jmp	.L11							# goto .L11
...
.L11:
	mov	rax, r12					# eax = i
	cmp	rax, QWORD PTR -28[rbp]					# compare (eax, valid_size)
